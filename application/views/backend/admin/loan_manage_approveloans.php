    ...
    <tbody>
        ...
        <?php 
            ...
            <tr>
				...
				<a href="#" class="btn btn-danger btn-sm btn-icon icon-left" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/loan_manage_approveloans/delete/<?php echo $row['loan_id'];?>');">
