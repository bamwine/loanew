...
?>
    <div class="row">
    <?php echo form_open(base_url() . 'index.php?admin/loan_manage_approveloans/do_update/'. $row['loan_id'], 
...
<label  class="col-sm-3 control-label"><?php echo get_phrase('maturity_date');?></label>
	<div class="col-sm-9">
		<div class="">
		<!--data-format="D, dd MM yyyy"-->
			<input type="text" name="maturity_date"  class="form-control datepicker" data-format="yyyy-mm-dd" value="<?php echo $row['maturity_date'];?>" required placeholder="date here">
		</div>
	</div>
</div>
...
<hr>
				  ...
				  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="number" class="form-control" name="g_number"  value="<?php echo $row['g_number'];?>" required>
