...
$url = ($row_data->paymentmodes_id=="")?'index.php?admin/loan_settings_paymentmodes/create':'index.php?admin/loan_settings_paymentmodes/do_update/'.$row_data->paymentmodes_id;	
