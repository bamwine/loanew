...
<a type="button" class="btn bg-blue margin" href="<?php echo base_url();?>index.php?admin/loan_manage_approveloans_detailsalloans/<?php echo $row['staff_name'];?>">View All Loans</a>
<a type="button" class="btn bg-red margin  " href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/loan_manage_approveloans/delete/<?php echo $row['loan_id'];?>');">
                    ...
                    <tbody>
                        ...
                        <tr>
					     ...
					     <i class="entypo-pencil"></i>
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/loan_manage_approveloans_details/delete/collateral/<?php echo $rows['collateral_id'];?>/<?php echo $row['loan_id'];?>');">
                ...
                <table class="table table-bordered datatable" id="table_export">
					...
					<?php $count = 1;foreach($collateral_files as $rows):?> 
                    	 <tr>
							...
							<a onclick="confirm_modal('<?php echo base_url();?>index.php?admin/loan_manage_approveloans_details/delete/removefile/<?php echo $rows['collateral_id'];?>/<?php echo $row['loan_id'];?>');"
