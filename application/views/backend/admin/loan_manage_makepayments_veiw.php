...
<div class="panel-title">
 <?php echo get_phrase('Payment Information Page');?></div>
</div>
...
<form action="index.php?admin/loan_manage_makepayments/create" class="form-horizontal form-groups-bordered validate" target="_top" method="post" accept-charset="utf-8" novalidate="novalidate">
<div class="row">
<div class="col-md-6">
...
<div class="col-sm-9">     <!-- data-format="yyyy-mm-dd" -->
