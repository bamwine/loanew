<?php
$row_data = $this->db->get_where('loan_types' , array('class_id' => $param2))->row();
		
$url = ($row_data->class_id=="")?'index.php?loansofficer/loan_settings_loan_types/create':'index.php?loansofficer/loan_settings_loan_types/do_update/'.$row_data->class_id;	
$labelname = ($row_data->class_id=="")?'add_loan_type':'edit_loan_type';	
