...
<a href="#" 
				...
				<a type="button" class="btn bg-red margin  " href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?loansofficer/loan_manage_historypayments/delete/<?php echo $row['invoice_id'];?>');">
