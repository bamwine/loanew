...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="x_panel" >
            ...
            <div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?loansofficer/system_settings/do_update', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top'));
                ?>
    ...
    <div class="col-md-6">
        ...
        <?php echo form_open(base_url() . 'index.php?loansofficer/system_settings/upload_logo', array(
...
<script type="text/javascript">
    $(".gallery-env").on('click', 'a', function () {
        skin = this.id;
        $.ajax({
            url: '<?php echo base_url(); ?>index.php?loansofficer/system_settings/change_skin/' + skin,
            success: window.location = '<?php echo base_url(); ?>index.php?loansofficer/system_settings/'
        });
    });
</script>