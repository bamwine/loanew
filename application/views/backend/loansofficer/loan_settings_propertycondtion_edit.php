...
$url = ($row_data->condition_id=="")?'index.php?loansofficer/loan_settings_propertycondtion/create':'index.php?loansofficer/loan_settings_propertycondtion/do_update/'.$row_data->condition_id;	
