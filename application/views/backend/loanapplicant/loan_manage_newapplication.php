<hr />
    ...
    <div class="row">
    <?php echo form_open(base_url() . 'index.php?loanapplicant/loan_manage_newapplication/create' , 
            ...
            <div class="x_panel" >
                ...
                <div class="panel-body">
		  			...
		  			<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class=""><!--data-format="D, dd MM yyyy"-->
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
 										<select name="staff_name" class="form-control select2" style="width:100%;" required>
										  ...
										  <?php 
										$teachers = $this->crud_model->loan_client_info($this->session->userdata('student_id'));										
                              ...
                              <option value=""><?php echo get_phrase('select');?></option>
							   ...
							   <?php 
										...
										?>
                                    		...
                                    		<option value="<?php echo $row['branch_id'];?>"><?php echo $this->crud_model->get_branch_name_by_id($row['branch_id']);?></option>
                                        <?php
										endforeach;
										?>
