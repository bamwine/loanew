...
<div class="mail-compose">
    ...
    <?php echo form_open(base_url() . 'index.php?loanapplicant/message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
    ...
    <div class="form-group">
        ...
        <br><br>
            ...
            <optgroup label="<?php echo get_phrase('Loans_Officer'); ?>">
                <?php
                $students = $this->db->get('loan_officer')->result_array();
                foreach ($students as $row):
                    ?>

                    <option value="student-<?php echo $row['teacher_id']; ?>">
                        - <?php echo $row['name']; ?></option>
