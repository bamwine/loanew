...
class Mobile extends CI_Controller
{
    ...
    function get_class() {
        $response       =   $this->db->get('loan_types')->result_array();
    ...
    function get_students_of_class() {
        ...
        foreach ($students as $row) {
            ...
            $data['roll']       =   $row['roll'];
            $data['class']      =   $this->db->get_where('loan_types' ,      array('class_id'    =>  $row['class_id']))->row()->name;
    ...
    function get_student_profile_information() {
        ...
        $student_profile=   $this->db->get_where('loan_clients' , array('student_id' => $student_id))->result_array();
    ...
    function get_teacher_profile() {
        ...
        $response       =   $this->db->get_where('loan_officer' , array('teacher_id' => $teacher_id))->row();
        echo json_encode($response);
...
// librarian list of the school
    ...
    function get_accounting() {
        ...
        $response       =   $this->db->get('loan_payment')->result_array();
        echo json_encode($response);
    }
    ...
    function get_subject_of_class() {
        ...
        foreach ($subjects as $row) {
            ...
            $teacher_query              =   $this->db->get_where('loan_officer' , array('teacher_id' =>  $row['teacher_id']));
    ...
    function get_marks() {
        ...
        foreach ( $marks as $row ) {
            $data['class_id']       =   $row['class_id'];
            $data['student_id']     =   $row['student_id'];
            $data['student_name']   =   $this->db->get_where('loan_clients', array('student_id' => $row['student_id']))->row()->name;
            $data['student_roll']   =   $this->db->get_where('loan_clients', array('student_id' => $row['student_id']))->row()->roll;
    ...
    function get_total_summary() {
        ...
        $response       =   array();
        $response['total_student']      = $this->db->count_all('loan_clients');
        $response['total_teacher']      = $this->db->count_all('loan_officer');
    ...
    function get_children_of_parent() {
        ...
        $response       =   array();
        $parent_id      =   $this->input->post('parent_id');
        $response['children']       =   $this->db->get_where('loan_clients' , array('parent_id' => $parent_id))->result_array();
        echo json_encode($response);
    }
    ...
    function get_single_student_accounting() {
        ...
        $response       =   $this->db->get('loan_invoice')->result_array();
        echo json_encode($response);
    }
    ...
    function login() {
        ...
        $query = $this->db->get_where('loan_officer', array('email' => $email , 'password' => $password));
        if ($query->num_rows() > 0) {
            $row = $query->row();
        ...
        $query = $this->db->get_where('loan_clients',  array('email' => $email , 'password' => $password));
        if ($query->num_rows() > 0) {
            $row = $query->row();
        ...
        if ($query->num_rows() > 0) {
            ...
            $response['children']       =   $this->db->get_where('loan_clients' , array('parent_id' => $row->parent_id))->result_array();
    ...
    function reset_password() {
        ...
        $query = $this->db->get_where('loan_clients' , array('email' => $email));
        if ($query->num_rows() > 0) 
        {
        ...
        $query = $this->db->get_where('loan_officer' , array('email' => $email));
        if ($query->num_rows() > 0) 
        {
