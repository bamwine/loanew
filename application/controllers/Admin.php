...
class Admin extends CI_Controller
{
    ...
    function loan_client($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->email_model->account_opening_email('student', $data['email']); //SEND EMAIL ACCOUNT OPENING EMAIL
             redirect(base_url() . 'index.php?admin/loan_client_information/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = $this->input->post('name');
            $data['birthday']   = $this->input->post('birthday');
    ...
    function loan_officer($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?admin/loan_officer/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['birthday']    = $this->input->post('birthday');
    ...
    function loan_settings_loan_types($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?admin/loan_settings_loan_types/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = $this->input->post('name');
    ...
    function loan_settings_branches($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?admin/loan_settings_branches/', 'refresh');
    ...
    function loan_settings_paymentmodes($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?admin/loan_settings_paymentmodes/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = $this->input->post('name');
    ...
    function loan_settings_propertycondtion($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?admin/loan_settings_propertycondtion/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = $this->input->post('name');
    ...
    function loan_settings_generalnterest($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?admin/loan_settings_generalnterest/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = $this->input->post('name');
    ...
    function loan_manage_newapplication($param1 = '', $param2 = '' , $param3 = '')
    {
       if ($this->session->userdata('admin_login') != 1)
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?admin/loan_manage_newapplication' , 'refresh');
        }
	...
	function loan_manage_approveloans_details($param1 = '' , $param2 = '' , $param3 = '', $param4 = '')
	{
		...
		if ($param1 == 'save_collateral') {
            ...
            redirect(base_url() . 'index.php?admin/loan_manage_approveloans_details/'.$loan_id, 'refresh');
			}
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?admin/loan_manage_approveloans_details/'.$param4, 'refresh');
        }
    ...
    function loan_manage_approveloans($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            move_uploaded_file($_FILES["file_name"]["tmp_name"], "uploads/loan_applicant/" . h_generate_id($_FILES["file_name"]["name"]).".$ext");
			$this->session->set_flashdata('flash_message' , get_phrase('loan_application_submitted_successfully'));
            redirect(base_url() . 'index.php?admin/loan_manage_approveloans' , 'refresh');
        }
		...
		if ($param1 == 'changeamount') {
            ...
            $this->db->update('loan', $data);
			 redirect(base_url() . 'index.php?admin/loan_manage_approveloans_details/'.$param2, 'refresh');
		}
		if ($param1 == 'do_update') {
	...
	function loan_manage_makepayments($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?admin/loan_manage_makepayments_veiw/'.$loan_id, 'refresh');
        }
    ...
    function loan_manage_historypayments($param1 = '' , $param2 = '')
    {
       if ($this->session->userdata('admin_login') != 1)
		...
		if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?admin/loan_manage_historypayments', 'refresh');
        }
  ...
  /***MANAGE EVENT / NOTICEBOARD, WILL BE SEEN BY ALL ACCOUNTS DASHBOARD**/
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
	   ...
	   /******MANAGE loan reports***/
	     ...
	     function loan_reports_daily()
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(base_url(), 'refresh');
       
        
        $page_data['page_info']  = 'Daily Reports';
        $page_data['page_name']  = 'loan_reports_daily';
        $page_data['page_title'] = get_phrase('Daily Reports');
        $this->load->view('backend/index', $page_data);
    }
